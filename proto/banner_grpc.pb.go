...
func (c *bannerClient) UpdateBanner(ctx context.Context, in *UpdateBannerRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/Banner/UpdateBanner", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBannerServer) UpdateBanner(context.Context, *UpdateBannerRequest) (*emptypb.Empty, error) {
...
func _Banner_UpdateBanner_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Banner/UpdateBanner",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
